<template>
    <div class="app-container calendar-list-container">
        ...
        <ImageCropper :width="300" :height="300" :field="'file'" :url="cropUploadUrl" @crop-upload-success="cropSuccess" v-show="imageCropperShow" :key="imageCropperKey" />
    </div>
</template>
<script>
...
export default {
    ...
    data() {
        return {
            ...
            imageCropperKey: 0,
            cropUploadUrl: process.env.BASE_API + '/api/attachments/upload',
            form: {
                name: '',
                mail: '',
                avatarUrl: ''
    ...
    methods: {
        getContacts() {
            ...
            contactsAPI.fetchList(this.listQuery).then(res => {
                ...
                this.list.forEach(item => item.avatarUrl = resolveApiUrl(item.avatarUrl));
        ...
        cropSuccess(resData) {
            ...
            this.form.avatarUrl = resolveApiUrl(resData.url);
        },
        submit() {
